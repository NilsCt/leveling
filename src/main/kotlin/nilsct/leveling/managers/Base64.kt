...
import nilsct.leveling.Bot.Companion.base64Key
...
//            if (c > 0 && c / 3 * 4 % 76 == 0) r += "\r\n"
                ...
                // character list
                r += ("" + base64Key[n1] + base64Key[n2]
                        + base64Key[n3] + base64Key[n4])
                c += 3
            }
        ...
        fun decode(msg: String): String {
            ...
            while (c < s.length) {
                ...
                val n = ((base64Key.indexOf(s[c]) shl 18)
                        + (base64Key.indexOf(s[c + 1]) shl 12)
                        + (base64Key.indexOf(s[c + 2]) shl 6)
                        + base64Key.indexOf(s[c + 3]))
